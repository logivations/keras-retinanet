...
def main(args=None):
    ...
    if args.snapshot is not None:
        ...
        model = keras.models.load_model('snapshots/train_all_from21_2 class/resnet50_pascal_16.h5', custom_objects=custom_objects)
        training_model = model
        prediction_model = model
        ...
        model, training_model, prediction_model = create_models(
            ...
            weights=model.load_weights('snapshots/train_all_from21_2 class/resnet50_pascal_16.h5'),
...
# keras_retinanet/bin/train.py pascal ../../keras-retinanet-master_new/train_6
