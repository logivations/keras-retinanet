...
def draw_caption(image, box, caption):
    ...
    """
    b = np.array(box).astype(int)
    cv2.putText(image, caption, (b[0] - 10, b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 0), 2)
    cv2.putText(image, caption, (b[0] - 10, b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 3)
